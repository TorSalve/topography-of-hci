...
**The Topography of Human-Computer Interaction (HCI)** is a physical and digital representation of the many peaks, valleys, and connections that make up the HCI community. At its heart, the topography is built collaboratively.

Participants were invited to add a piece of modeling clay to a shared table. Each piece represents their own area of expertise, research method, or perspective within HCI.

Participants could mark their clay to label methods, theories, or ideas, turning the sculpture into a conversation piece and map at the same time.

To make this evolving landscape accessible after the conference, we regularly captured the sculpture using a **3D scanning app** (Scandiverse on iPad). With each scan we produced a **3D digital model** preserving the shape in detail.
...
- **Small flags** or **paper stickers** (paper + toothpicks or pins)
- Markers to write keywords on the flags/stickers
